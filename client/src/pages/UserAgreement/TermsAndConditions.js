            ...
            <div className="legal-document">
              ...
              <section className="legal-section">
                ...
                <p className="legal-text">
                  ...
                  saumya & Company Pvt Ltd and are protected by international copyright, trademark, 
              ...
              <section className="legal-section">
                ...
                <p className="legal-text">
                  In no event shall Saumya & Company Pvt Ltd, its directors, employees, or agents 
              ...
              <section className="legal-section">
                ...
                <ul className="legal-list">
                  <li>Email: mathursaumya.1505@gmail.com</li>
                  <li>Email: info.saumya.company@gmail.com</li>
                  <li>Phone: +91 8873323323</li>
                  <li>Address: Saumya & Company Pvt. Ltd, BCIT Park, Bangalore, Karnataka, India 560064</li>
                </ul>
              </section>
              ...
              <section className="legal-section">
                ...
                <p className="legal-text">
                  These Terms constitute the entire agreement between you and Saumya & Company Pvt Ltd 
