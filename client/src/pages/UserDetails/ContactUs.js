              ...
              <div className="contact-info">
                <div className="contact-detail">
                  ...
                  <div className="contact-info-content">
                    ...
                    <div className="contact-text">Saumya & Company Pvt. Ltd, BCIT Park</div>
                ...
                <div className="contact-detail">
                  ...
                  <div className="contact-info-content">
                    ...
                    <div className="contact-text">
                      <a href="mailto:saumya@gmail.com">
                        saumya@gmail.com
                      </a>
                    </div>
                    <div className="contact-text">
                      <a href="mailto:info.saumya.company@gmail.com">
                        info.saumya.company@gmail.com
                      </a>
                    </div>
                  </div>
                </div>
