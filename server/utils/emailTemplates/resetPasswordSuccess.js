                    ...
                    <tr>
                        <td class="email-content" style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 24px 0; color: #4b5563; font-size: 15px; line-height: 1.7;">
                                This is a confirmation email to let you know that your password for your <strong style="color: #6366f1;">Expense Management System</strong> account has been successfully reset.
                            </p>
                            ...
                            <div style="background: #fef3c7; border-left: 4px solid #f59e0b; border-radius: 8px; padding: 16px; margin: 24px 0;">
                                <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
                                    🔒 <strong>Security Check:</strong> If you did not reset your password, please contact us immediately at <a href="mailto:${EMAIL_FROM}" style="color: #dc2626; text-decoration: none; font-weight: 600;">${EMAIL_FROM}</a>
                                </p>
                            </div>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin: 32px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="https://expense-management-system-prakash.netlify.app/login" style="display: inline-block; background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); color: #ffffff; text-decoration: none; padding: 16px 32px; border-radius: 10px; font-size: 16px; font-weight: 600; box-shadow: 0 4px 15px rgba(99, 102, 241, 0.4);">
                            ...
                            <p style="margin: 32px 0 0 0; color: #4b5563; font-size: 14px; line-height: 1.7;">
                                If you have any questions or concerns, feel free to reach out to us at <a href="mailto:${EMAIL_FROM}" style="color: #6366f1; text-decoration: none; font-weight: 600;">${EMAIL_FROM}</a>
                            </p>
                    ...
                    <tr>
                        <td style="background: #f9fafb; border-top: 1px solid #e5e7eb; padding: 24px 40px; text-align: center;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 16px;">
                                        <a href="https://www.linkedin.com/in/saumya-m-a4049b28b/" style="display: inline-block; margin: 0 12px; text-decoration: none;">
                            ...
                            <p style="margin: 0; color: #9ca3af; font-size: 12px; line-height: 1.6;">
                                This message was sent from Saumya & Company Pvt. Ltd<br>
